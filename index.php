...
<head>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, beige-scale=1">
...
<body>
    ...
    <header>
        <div class="container">
        <h1><a href="index.php">Art Gallery Website</a></h1>
        <ul>
          ...
          <h3>Kategori</h3>
				...
				?>
                    <a href="galeri.php?kat=<?php echo $k['category_id'] ?>">
                        <div class="col-5">
                        <img src="img/icon.png" width="70px" style="margin-bottom:7px;" />
   ...
   <div class="section">
       ...
       <h3>Foto Terbaru</h3>
          ...
          <div class="col-4">
              <img src="img/foto/<?php echo $p['image'] ?>" height="150px" />
